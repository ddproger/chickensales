...
@WebServlet("/franchise")
public class FranchiseController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static String SHOW = "/franchise.jsp";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("currentPage", "franchise");
		String forward = "";
			forward = SHOW;
